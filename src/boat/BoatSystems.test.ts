...
describe("BoatSystems", () => {
  ...
  it("toggles electrical systems independently and clamps radio controls", () => {
    ...
    systems.activate("anchorLight");
    systems.activate("instrumentLights");
    systems.activate("wipers");
    ...
    expect(systems.state.anchorLight).toBe(true);
    expect(systems.state.instrumentLights).toBe(true);
    expect(systems.state.wipers).toBe(true);
    expect(systems.state.bilgePump).toBe(true);
